...
public class AddCourseControllerG {

	 private static AddCourseUI view;
	 private static OrganizationProfileUI orgview;
	 private static AddCourseControllerG instance = null;
	 private static OrganizationProfile model;
	 
	 private AddCourseControllerG(AddCourseUI addCourseView, OrganizationProfileUI organizationView, OrganizationProfile orgModel) {
		 view = addCourseView;
		 orgview = organizationView;
		 model = orgModel;
	 }
	 
	 public static synchronized AddCourseControllerG getInstance(AddCourseUI view, OrganizationProfileUI orgview, OrganizationProfile model) {
		 if(instance == null) {
			 instance = new AddCourseControllerG(view, orgview, model);
