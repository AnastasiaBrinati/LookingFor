...
/*public class AggiungereBottono {

	 private static AddCourseUI view;
	 private static OrganizationProfileUI orgview;
	 private static AggiungereBottono instance = null;
	 private static OrganizationProfile model;
	 
	 private AggiungereBottono(AddCourseUI addCourseView, OrganizationProfileUI organizationView, OrganizationProfile orgModel) {
		 view = addCourseView;
		 orgview = organizationView;
		 model = orgModel;
	 }
	 
	 public static synchronized AggiungereBottono getInstance(AddCourseUI view, OrganizationProfileUI orgview, OrganizationProfile model) {
		 if(instance == null) {
			 instance = new AggiungereBottono(view, orgview, model);
