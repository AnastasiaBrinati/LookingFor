...
public class OrganizationProfileUI extends JFrame {
	...
	public OrganizationProfileUI() {
		...
		homeButton.setBounds(10, 0, 45, 42);
		...
		coursesPanel.setBounds(268, 132, 962, 511);
		...
		PANEL.setBounds(10, 150, 931, 331);
		coursesPanel.add(PANEL);
		
		//events
		eventsPanel.setBounds(268, 132, 962, 511);
		...
		//courts
		courtsPanel.setBounds(268, 132, 962, 511);
		...
		panel_1.setBounds(268, 39, 962, 93);
		...
		descriptionPanel.setBounds(268, 132, 962, 511);
