...
public class OrganizationProfileUI extends JFrame {
	...
	private JButton settingsButton = new JButton("",new ImageIcon("/Img/settings.png"));
	...
	public OrganizationProfileUI() {
		...
		headerPanel.setBackground(new Color(102, 0, 153));
		...
		settingsButton.setBounds(10, 0, 39, 42);
		...
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\giuli\\Downloads\\photo-1557682268-e3955ed5d83f.jpg"));
		lblNewLabel_5.setBounds(0, 0, 269, 604);
